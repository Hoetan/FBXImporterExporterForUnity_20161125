...
FBX Importer & Exporter for Unity β Trial Version 2016/11/25
...
　「C:\Program Files\Autodesk\FBX\FBX SDK\2017.0.1\lib\vs2015\x64\release\libfbxsdk.dll」を、Unityプロジェクトのルート（※）へコピーしてください。
